# Asset Shepherd Technical Setup and Deployment Guide

[Back to the project introduction and judge testing guide](../README.md)

Commands below run from the repository root. This guide covers developer setup and recorded
hosting configuration; judges can use the hosted site without installing anything.
...
See [current status](PROJECT_STATUS.md), [deployment procedure](BEDROCK_DEPLOYMENT_RUNBOOK.md),
[sign-in operations](HOSTED_LOGIN_RUNBOOK.md), [hosted OpenAI](HOSTED_OPENAI_RUNBOOK.md),
and [spending safety](MODEL_SPENDING_RUNBOOK.md) for acceptance evidence and remaining gates.

## Project control

- [Project contract](PROJECT_CONTRACT.md)
- [Agent-orchestrated workflow](AGENT_ORCHESTRATED_WORKFLOW.md)
- [Agent operating contract](AGENT_OPERATING_CONTRACT.md)
- [Real-world validation plan](REAL_WORLD_VALIDATION_PLAN.md)
- [Project status](PROJECT_STATUS.md)
- [Decision log](DECISIONS.md)
- [Contest compliance plan](CONTEST_COMPLIANCE_PLAN.md)
- [Web design and flow](WEB_DESIGN_AND_FLOW.md)
- [Checks and authority](CHECKS_AND_AUTHORITY.md)
- [Original component-handling design](FUTURE_COMPONENT_HANDLING.md) — historical proposal;
...
[`docs/BEDROCK_DEPLOYMENT_RUNBOOK.md`](BEDROCK_DEPLOYMENT_RUNBOOK.md). Follow its gates in order;
